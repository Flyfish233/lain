...
fun loadI8mmModel(context: Context) = listOf(
    ...
    Model(
        ...
        url = Uri.parse("https://huggingface.co/flyfishstudio/gemma-2-2b-it-abliterated-Q4_0_4_8.gguf/resolve/main/gemma-2-2b-it-abliterated-Q4_0_4_8.gguf"),
        desc = "",
        space = "1.63 GB"
    ),
    Model(
    ...
    Model(
        ...
        url = Uri.parse("https://huggingface.co/flyfishstudio/Phi-3.5-mini-instruct_Uncensored-Q4_0_4_8.gguf/resolve/main/Phi-3.5-mini-instruct_Uncensored-Q4_0_4_8.gguf"),
        desc = "",
        space = "2.18 GB"
    ),
    Model(
    ...
    Model(
        ...
        url = Uri.parse("https://huggingface.co/flyfishstudio/meta-llama-3.1-8b-instruct-abliterated-Q4_0_4_8.gguf/resolve/main/meta-llama-3.1-8b-instruct-abliterated-Q4_0_4_8.gguf"),
        desc = "",
        space = "4.66 GB"
    ),
    Model(
    ...
    Model(
        ...
        url = Uri.parse("https://huggingface.co/dabr1/Llama-3.1-8B-Lexi-Uncensored_V2-Q4_0_4_8.gguf/resolve/main/Llama-3.1-8B-Lexi-Uncensored_V2-Q4_0_4_8.gguf"),
        desc = "",
        space = "4.66 GB"
    ),
    Model(
        ...
        url = Uri.parse("https://huggingface.co/dabr1/DarkIdol-Llama-3.1-8B-Instruct-1.2-Uncensored-Q4_0_4_8.gguf/resolve/main/DarkIdol-Llama-3.1-8B-Instruct-1.2-Uncensored-Q4_0_4_8.gguf"),
        desc = "",
        space = "4.66 GB"
    ),
    Model(
        ...
        url = Uri.parse("https://huggingface.co/flyfishstudio/gemma-2-9b-it-abliterated-Q4_0_4_8.gguf/resolve/main/gemma-2-9b-it-abliterated-Q4_0_4_8.gguf"),
        desc = "",
        space = "5.44 GB"
    ),
    Model(
